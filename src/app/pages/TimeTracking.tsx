          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <select
                ...
                disabled={isRunning}
                className="border border-[rgba(26,26,26,0.15)] px-4 py-2.5 text-[12px] text-[#1a1a1a] bg-white outline-none disabled:opacity-50 min-w-[180px]"
                style={{ fontFamily: "'Inter', sans-serif" }}
              >
              ...
              <button
                ...
                className={`flex items-center gap-2 px-6 py-3 text-[12px] font-semibold tracking-[0.5px] uppercase transition-colors disabled:opacity-40 ${
                  isRunning
